...
CREATE TABLE `goods_info` (
  ...
  `discount_price` decimal(15,2) DEFAULT NULL COMMENT '折后价',
  `normal_price` decimal(15,2) DEFAULT NULL COMMENT '原始价',
...
CREATE TABLE `order_detail` (
  `id` int NOT NULL AUTO_INCREMENT,
  `order_id` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL '订单ID',
  `goods_id` int DEFAULT NULL COMMENT '商品ID',
  `goods_num` int DEFAULT NULL COMMENT '商品数量',
  `price` decimal(15,2) DEFAULT NULL COMMENT '购买时价格',
...
CREATE TABLE `order_main_info` (
  ...
  `total_price` decimal(15,2) DEFAULT NULL COMMENT '商品总价（元）',
...
CREATE TABLE `receiver_info` (
  ...
  `phone_number` char(12) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '手机号码',
