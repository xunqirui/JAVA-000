...
/**
 * KlassBeanDefinitionParser
 *
 * @author qrXun on 2020/11/15
 */
public class KlassBeanDefinitionParser extends AbstractSingleBeanDefinitionParser {
    ...
    protected void doParse(Element element, ParserContext parserContext, BeanDefinitionBuilder builder) {
        ...
        for (int i = 0; i<nodeList.getLength();i++){
            ...
            if (!ObjectUtils.isEmpty(nodeMap)){
                ...
                registry.registerBeanDefinition("list#" + i, beanDefinitionBuilder.getBeanDefinition());
                builder.addPropertyReference(nameNode.getNodeValue(), "list#" + i);
